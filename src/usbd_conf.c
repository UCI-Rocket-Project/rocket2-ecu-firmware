...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  */
    ...
    PA12     ------> USB_OTG_FS_DP
    */
    GPIO_InitStruct.Pin = USB_VBUS_SENS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(USB_VBUS_SENS_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = USB_CONN_D__Pin|USB_CONN_D_A12_Pin;
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  /* USER CODE END USB_OTG_FS_MspDeInit 0 */
    ...
    PA12     ------> USB_OTG_FS_DP
    */
    HAL_GPIO_DeInit(GPIOA, USB_VBUS_SENS_Pin|USB_CONN_D__Pin|USB_CONN_D_A12_Pin);
