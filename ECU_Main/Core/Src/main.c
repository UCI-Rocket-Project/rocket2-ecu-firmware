...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, SOLENOID3_EN_Pin|SOLENOID4_EN_Pin|STATUS_LED_Pin|IMU_nCS2_Pin
  ...
  /*Configure GPIO pins : ECU_BV_Pin USB_VBUS_SENS_Pin */
  GPIO_InitStruct.Pin = ECU_BV_Pin|USB_VBUS_SENS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : SOLENOID4_FB_Pin ETH_CP2_Pin MAG_INT_Pin */
  GPIO_InitStruct.Pin = SOLENOID4_FB_Pin|ETH_CP2_Pin|MAG_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : SOLENOID3_EN_Pin SOLENOID4_EN_Pin STATUS_LED_Pin IMU_nCS2_Pin
                           IMU_nCS1_Pin */
  GPIO_InitStruct.Pin = SOLENOID3_EN_Pin|SOLENOID4_EN_Pin|STATUS_LED_Pin|IMU_nCS2_Pin
                          |IMU_nCS1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
